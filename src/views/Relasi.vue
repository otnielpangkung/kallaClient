		...
		<div class="row justify-content-center">
			<div class="col col-lg-10 mt-3">
				...
				<button
					id="download"
					class="btn"
					@click.prevent="tableHtmlToExcel('relasiTable')"
				>
				...
				>
					...
					<tbody>
						<tr v-for="relasi in relasiUser" :key="relasi.id">
							...
							<td id="uang">
								{{
									totalRelisasi(relasi.Realisasis) -
										totalRelisasi(relasi.Schedules)
								}}
							</td>
						...
						<tr>
							...
							<th colspan="3">
								{{
									persen(
										getTotalVolume(this.realisasiUser),
										getTotalVolume(this.sheduleUser)
									)
								}}
								%
							</th>
