				...
				<div class="form-row mb-3">
					...
					<div class="input-group col-sm">
						...
						<select class="form-control" v-model="cabang">
							...
							<option
								v-for="user in setUser()"
								:key="user.id"
								:value="user.id"
								>{{ user.namaCabang }}</option
							>
						</select>
					</div>
					<button
				...
				<table class="table table-striped" id="table">
					...
					<tbody>
						<tr v-for="relasi in filterData()" :key="relasi.id">
							...
							<td id="uang">
								{{
									getTotalVolume(relasi.Realisasis) -
										getTotalVolume(relasi.Schedules)
								}}
							</td>
						</tr>
						<tr>
						...
						<tr>
							...
							<th colspan="3">
								{{
									persen(
										getTotal(this.allRealisasi),
										getTotal(this.allSchedule)
									)
								}}
								%
							</th>
