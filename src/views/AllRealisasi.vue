      ...
      <table class="table table-hover table-striped table-bordered" id="table">
        ...
        <tbody>
          <tr v-for="data in this.filterData()" :key="data.id">
            ...
            <td></td>
            <td>
              <i v-if="cekSelisih(data.pasir,data.Item.stdPasir)" class="fas fa-arrow-up"></i>
              <i v-if="!cekSelisih(data.pasir,data.Item.stdPasir)" class="fas fa-arrow-down"></i>
            ...
            <td></td>
            <td>
              <i v-if="cekSelisih(data.cipping,data.Item.stdCpping)" class="fas fa-arrow-up"></i>
              <i v-if="!cekSelisih(data.cipping,data.Item.stdCpping)" class="fas fa-arrow-down"></i>
