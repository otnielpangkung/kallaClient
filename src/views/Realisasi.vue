<template>
	<div class="Realisasi">
		...
		<button @click.prevent="showAdd" class="btn btn-primary">
			Tambahkan BP
		</button>
		<!-- Modal -->
			...
			<div class="modal-dialog">
				...
				<div class="modal-content">
					<div class="modal-body">
						<form
							@submit.prevent="editStatus ? editRealisasi() : addRealisasi()"
						>
							...
							<div class="form-row mb-1">
								<div class="col-sm">
									<label class="my-1 mr-2" for="RelasiId"
										>No.Wo - Relasi - Lokasi</label
									>
									<div class="input-group">
										<select
											class="form-control"
							...
							<button v-if="editStatus" class="btn btn-secondary" type="submit">
								Edit
							</button>
						</form>
					</div>
